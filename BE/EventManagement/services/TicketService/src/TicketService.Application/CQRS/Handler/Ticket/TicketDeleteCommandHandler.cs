...
{
    public class TicketDeleteCommandHandler : IRequestHandler<TicketDeleteCommand, TicketDeleteResponse>
    {
        private readonly ITicketUnitOfWork _unitOfWork;
        private readonly EventGrpc.EventGrpcClient _eventGrpcClient;
        public TicketDeleteCommandHandler(ITicketUnitOfWork unitOfWork, EventGrpc.EventGrpcClient eventGrpcClient)
        {
            _unitOfWork = unitOfWork;
            _eventGrpcClient = eventGrpcClient;
        }

        public async Task<TicketDeleteResponse> Handle(TicketDeleteCommand request, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                _unitOfWork.Tickets.DeleteAsync(ticket);
