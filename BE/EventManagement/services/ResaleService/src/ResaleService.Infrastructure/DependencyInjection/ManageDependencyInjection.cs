...
using ResaleService.Infrastructure.Implements.Repositories;
...
namespace ResaleService.Infrastructure.DependencyInjection
{
    public static class ManageDependencyInjection
    {
        public static IServiceCollection AddResaleServiceInfrastructure(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddSharedSwaggerGen("Resale Service API");
        ...
        {
            service.AddScoped<IResaleUnitOfWork, UnitOfWork>();

        }

        private static void AddMediatRInfrastructure(this IServiceCollection service, IConfiguration config)
        {
            var applicationAssembly = Assembly.Load("ResaleService.Application");
