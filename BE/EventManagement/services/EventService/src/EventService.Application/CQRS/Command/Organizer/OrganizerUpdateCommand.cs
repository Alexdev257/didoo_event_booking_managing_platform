...
{
    public class OrganizerUpdateCommand : IRequest<OrganizerUpdateResponse>, IValidatable<OrganizerUpdateResponse>
    {
        [JsonIgnore]
        ...
        public Task<OrganizerUpdateResponse> ValidateAsync()
        {
            var response = new OrganizerUpdateResponse();
