...
{
    public class OrganizerDeleteCommand : IRequest<OrganizerDeleteRepsonse>, IValidatable<OrganizerDeleteRepsonse>
    {
        public Guid Id { get; set; }

        public Task<OrganizerDeleteRepsonse> ValidateAsync()
        {
            var response = new OrganizerDeleteRepsonse();
