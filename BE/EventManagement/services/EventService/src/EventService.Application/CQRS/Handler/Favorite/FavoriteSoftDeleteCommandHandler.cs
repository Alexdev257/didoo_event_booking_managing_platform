...
{
    public class FavoriteSoftDeleteCommandHandler : IRequestHandler<FavoriteSoftDeleteCommand, FavoriteSoftDeleteResponse>
    {
        private readonly IEventUnitOfWork _unitOfWork;
        private readonly AuthGrpc.AuthGrpcClient _authGrpcClient;
        public FavoriteSoftDeleteCommandHandler(IEventUnitOfWork unitOfWork, AuthGrpc.AuthGrpcClient authGrpcClient)
        {
            _unitOfWork = unitOfWork;
            _authGrpcClient = authGrpcClient;
        }
        public async Task<FavoriteSoftDeleteResponse> Handle(FavoriteSoftDeleteCommand request, CancellationToken cancellationToken)
        {
            ...
            if (favorite == null)
            {
                return new FavoriteSoftDeleteResponse
                {
                    IsSuccess = false,
