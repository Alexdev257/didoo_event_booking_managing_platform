...
export const useGetEvents = (params?: EventGetListQuery, enabled = true) =>
  useQuery({
    ...
    queryFn: () => eventRequest.getList(params || {}).then((r) => r.data),
    enabled,
  });

export const useGetEvent = (id: string, params?: { hasTicketTypes?: boolean; hasLocations?: boolean }) =>
  useQuery({
    queryKey: [...QUERY_KEY.events.detail(id), params],
    queryFn: () => eventRequest.getById(id, params).then((r) => r.data),
    enabled: !!id,
  });

// Custom hook to fetch multiple events by IDs
export const useGetEventsByIds = (ids: string[], params?: { hasTicketTypes?: boolean; hasLocations?: boolean }) => {
  const uniqueIds = [...new Set(ids)].filter(Boolean);

  return useQuery({
    queryKey: ['events', 'by-ids', uniqueIds, params],
    queryFn: async () => {
      if (!uniqueIds.length) return [];
      const promises = uniqueIds.map((id) => eventRequest.getById(id, params).then((r) => r.data.data));
...
export const useEvent = () => {
  ...
  const create = useMutation({
    mutationFn: async (body: EventCreateBody) =>
      (await eventRequest.create(body)).data.data,
    onSuccess: () => {
  ...
  const update = useMutation({
    mutationFn: async ({ id, body }: { id: string; body: EventUpdateBody }) =>
      (await eventRequest.update(id, body)).data.data,
    onSuccess: (_, variables) => {
      toast.success("Event updated successfully");
      queryClient.invalidateQueries({ queryKey: KEY.events });
      if (variables.id) {
        queryClient.invalidateQueries({
          queryKey: QUERY_KEY.events.detail(variables.id),
        });
      }
    },
  });
  const updateStatus = useMutation({
    mutationFn: async ({
      ...
      (await eventRequest.updateStatus(id, { status })).data.data,
    onSuccess: (_, variables) => {
      if (variables.status === EventStatus.PUBLISHED)
        toast.success("Đã duyệt và xuất bản sự kiện thành công");
      else if (variables.status === EventStatus.DRAFT)
  ...
  const deleteEvent = useMutation({
    mutationFn: async (id: string) =>
      (await eventRequest.delete(id)).data.message,
    onSuccess: (data) => {
      toast.success(data);
      queryClient.invalidateQueries({ queryKey: KEY.events });
    },
  ...
  const restore = useMutation({
    mutationFn: async (id: string) =>
      (await eventRequest.restore(id)).data.message,
    onSuccess: (data) => {
      toast.success(data);
      queryClient.invalidateQueries({ queryKey: KEY.events });
    },
...
export const useGetCategories = (params?: CategoryGetListQuery) =>
  useQuery({
    ...
    queryFn: () => categoryRequest.getList(params || {}).then((r) => r.data),
    enabled: !!params,
  });
...
export const useGetCategory = (id: string) =>
  useQuery({
    ...
    queryFn: () => categoryRequest.getById(id).then((r) => r.data),
    enabled: !!id,
  });
...
export const useCategory = () => {
  ...
  const create = useMutation({
    mutationFn: async (body: CategoryCreateBody) =>
      (await categoryRequest.create(body)).data.data,
    onSuccess: () => {
  ...
  const update = useMutation({
    mutationFn: async ({
      id,
      body,
    }: { id: string; body: CategoryUpdateBody }) =>
      (await categoryRequest.update(id, body)).data.data,
    onSuccess: () => {
  ...
  const deleteCategory = useMutation({
    mutationFn: async (id: string) =>
      (await categoryRequest.delete(id)).data.message,
    onSuccess: (data) => {
      toast.success(data);
      queryClient.invalidateQueries({ queryKey: KEY.categories });
    },
  ...
  const restore = useMutation({
    mutationFn: async (id: string) =>
      (await categoryRequest.restore(id)).data.message,
    onSuccess: (data) => {
      toast.success(data);
      queryClient.invalidateQueries({ queryKey: KEY.categories });
    },
...
export const useGetOrganizers = (params?: OrganizerGetListQuery) =>
  useQuery({
    ...
    queryFn: () => organizerRequest.getList(params || {}).then((r) => r.data),
  });

export const useGetOrganizer = (id: string) =>
  useQuery({
    queryKey: QUERY_KEY.organizers.detail(id),
    queryFn: () => organizerRequest.getById(id).then((r) => r.data),
    enabled: !!id,
  });
...
export const useOrganizer = () => {
  ...
  const create = useMutation({
    mutationFn: async (body: OrganizerCreateBody) =>
      (await organizerRequest.create(body)).data.data,
    onSuccess: () => {
  ...
  const update = useMutation({
    mutationFn: async ({
      id,
      body,
    }: { id: string; body: OrganizerUpdateBody }) =>
      (await organizerRequest.update(id, body)).data.data,
    onSuccess: () =>
      queryClient.invalidateQueries({ queryKey: KEY.organizers }),
  });
  const verify = useMutation({
    mutationFn: async (id: string) =>
      (await organizerRequest.verify(id)).data.data,
    onSuccess: () => {
  ...
  const deleteOrganizer = useMutation({
    mutationFn: async (id: string) =>
      (await organizerRequest.delete(id)).data.message,
    onSuccess: (data) => {
      toast.success(data);
      queryClient.invalidateQueries({ queryKey: KEY.organizers });
    },
  ...
  const restore = useMutation({
    mutationFn: async (id: string) =>
      (await organizerRequest.restore(id)).data.message,
    onSuccess: (data) => {
      toast.success(data);
      queryClient.invalidateQueries({ queryKey: KEY.organizers });
    },
...
export const useGetEventReviews = (params?: EventReviewGetListQuery) =>
  useQuery({
    ...
    queryFn: () =>
      eventReviewRequest.getList(params || {}).then((r) => r.data),
  });

export const useGetEventReview = (id: string) =>
  useQuery({
    queryKey: QUERY_KEY.eventReviews.detail(id),
    queryFn: () => eventReviewRequest.getById(id).then((r) => r.data),
    enabled: !!id,
  });
...
export const useEventReview = () => {
  ...
  const create = useMutation({
    mutationFn: async (body: EventReviewCreateBody) =>
      (await eventReviewRequest.create(body)).data.data,
    onSuccess: () => {
  ...
  const update = useMutation({
    mutationFn: async ({
      id,
      body,
    }: { id: string; body: EventReviewUpdateBody }) =>
      (await eventReviewRequest.update(id, body)).data.data,
    onSuccess: () => {
  ...
  const deleteReview = useMutation({
    mutationFn: async (id: string) =>
      (await eventReviewRequest.delete(id)).data.message,
    onSuccess: (data) => {
      toast.success(data);
      queryClient.invalidateQueries({ queryKey: KEY.eventReviews });
    },
  ...
  const restore = useMutation({
    mutationFn: async (id: string) =>
      (await eventReviewRequest.restore(id)).data.message,
    onSuccess: (data) => {
      toast.success(data);
      queryClient.invalidateQueries({ queryKey: KEY.eventReviews });
    },
...
export const useGetFavorites = (params?: FavoriteGetListQuery) =>
  useQuery({
    ...
    queryFn: () => favoriteRequest.getList(params || {}).then((r) => r.data),
  });

export const useGetFavorite = (id: string) =>
  useQuery({
    queryKey: QUERY_KEY.favorites.detail(id),
    queryFn: () => favoriteRequest.getById(id).then((r) => r.data),
    enabled: !!id,
  });
...
export const useFavorite = () => {
  ...
  const create = useMutation({
    mutationFn: async (body: FavoriteCreateBody) =>
      (await favoriteRequest.create(body)).data.data,
    onSuccess: () => {
  ...
  const remove = useMutation({
    mutationFn: async ({
      ...
      (await favoriteRequest.delete(userId, eventId)).data.message,
    onSuccess: (data) => {
      toast.success(data);
      queryClient.invalidateQueries({ queryKey: KEY.favorites });
    },
  ...
  const softRemove = useMutation({
    mutationFn: async ({
      ...
      (await favoriteRequest.softDelete(userId, eventId)).data.message,
    onSuccess: (data) => {
      toast.success(data);
      queryClient.invalidateQueries({ queryKey: KEY.favorites });
    },
  ...
  const restore = useMutation({
    mutationFn: async ({
      ...
      (await favoriteRequest.restore(userId, eventId)).data.message,
    onSuccess: (data) => {
      toast.success(data);
      queryClient.invalidateQueries({ queryKey: KEY.favorites });
    },
...
export const useGetInteractions = (params?: InteractionGetListQuery) =>
  useQuery({
    ...
    queryFn: () =>
      interactionRequest.getList(params || {}).then((r) => r.data),
  });

export const useGetInteraction = (id: string) =>
  useQuery({
    queryKey: QUERY_KEY.interactions.detail(id),
    queryFn: () => interactionRequest.getById(id).then((r) => r.data),
    enabled: !!id,
  });
...
export const useInteraction = () => {
  ...
  const create = useMutation({
    mutationFn: async (body: InteractionCreateBody) =>
      (await interactionRequest.create(body)).data.data,
    onSuccess: () => {
  ...
  const remove = useMutation({
    mutationFn: async ({
      ...
      eventId,
      type,
    }: { userId: string; eventId: string; type: number }) =>
      (await interactionRequest.delete(userId, eventId, type)).data.message,
    onSuccess: (data) => {
      toast.success(data);
      queryClient.invalidateQueries({ queryKey: KEY.interactions });
    },
  ...
  const softRemove = useMutation({
    mutationFn: async ({
      ...
      (await interactionRequest.softDelete(userId, eventId, type)).data.message,
    onSuccess: (data) => {
      toast.success(data);
      queryClient.invalidateQueries({ queryKey: KEY.interactions });
    },
  ...
  const restore = useMutation({
    mutationFn: async ({
      ...
      (await interactionRequest.restore(userId, eventId, type)).data.message,
    onSuccess: (data) => {
      toast.success(data);
      queryClient.invalidateQueries({ queryKey: KEY.interactions });
    },
...
const formatCurrency = (value: number) =>
  `${formatNumber(Math.round(value))} VNĐ`;
const getTrend = (
  current: number,
  previous: number
): { change: string; trend: TrendDirection } => {
...
export const useOrganizerStats = (organizerId?: string) => {
  const { data: eventsRes, isLoading } = useGetEvents(
    { organizerId: organizerId, pageSize: 200 },
    Boolean(organizerId)
  );
  const { stats, chartData, events } = useMemo(() => {
    ...
    const getEventRevenue = (e: Event) =>
      toNumber((e as any).revenue ?? (e as any).totalRevenue ?? (e as any).grossRevenue ?? 0);
    const isActiveEvent = (e: Event) => {
      if (e.status === EventStatus.CANCELLED || e.status === EventStatus.CLOSED)
        return false;
      const endTime = new Date(e.endTime || e.startTime);
      return (
        (e.status === EventStatus.OPENED || e.status === EventStatus.PUBLISHED) &&
        endTime >= now
      );
    };
    for (const event of eventItems) {
      ...
      if (isActiveEvent(event)) totals.active += 1;
      if (startTime >= currentPeriodStart && startTime <= now) {
        ...
        if (isActiveEvent(event)) currentPeriod.active += 1;
      } else if (
        ...
        if (isActiveEvent(event)) previousPeriod.active += 1;
      }
    }
    const totalOccupancy =
      totals.capacity > 0 ? (totals.sold / totals.capacity) * 100 : 0;
    const currentOccupancy =
      currentPeriod.capacity > 0
        ? (currentPeriod.sold / currentPeriod.capacity) * 100
        : 0;
    const previousOccupancy =
      previousPeriod.capacity > 0
        ? (previousPeriod.sold / previousPeriod.capacity) * 100
        : 0;
    ...
    for (const point of sevenDayPoints) {
      point.occupancy =
        point.capacity > 0
          ? Number(((point.sales / point.capacity) * 100).toFixed(1))
          : 0;
    }
